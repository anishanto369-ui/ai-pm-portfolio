...
import { 
  MoveDown, MapPin, Mail, Phone, Linkedin, Shield, Info, FileText, Download, Scale
} from "lucide-react";
...
export default function Home() {
  ...
  return (
    <main className="relative min-h-[2600vh] md:min-h-[2000vh] selection:bg-orange-500 selection:text-white bg-transparent text-white font-sans overflow-x-hidden scroll-smooth w-full">
      <CanvasSequence
      ...
      >
         ...
         <div className="flex flex-col md:hidden w-full items-center gap-3 py-1 relative">
            ...
            <div className="flex flex-col items-center">
               <span className="font-serif font-bold text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-500 tracking-wide text-lg leading-none">Anish Anto</span>
            ...
            <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2 w-full text-[10px] text-white/80 font-mono">
               ...
               <a href="tel:+971521379125" className="flex items-center gap-1.5 hover:text-orange-400 transition-colors"><Phone className="w-3 h-3 opacity-70" /> +971 521 379 125</a>
            </div>
            <div className="grid grid-cols-2 gap-3 w-full mt-1">
               <a href="/Anish_Anto_AI_PM.pdf" download className="h-10 flex items-center justify-center gap-2 bg-gradient-to-r from-red-500 to-orange-500 rounded-xl text-[10px] font-mono font-bold uppercase tracking-widest text-white active:scale-95 transition-all shadow-lg">
                 <Download className="w-3.5 h-3.5" /> CV
               </a>
               <a href="https://wa.me/971521379125" target="_blank" className="h-10 flex items-center justify-center bg-white text-black rounded-xl text-[10px] font-mono font-bold uppercase tracking-widest active:scale-95 transition-all shadow-lg">
                 Hire Me
               </a>
            </div>
         </div>
         ...
         <div className="hidden md:flex flex-row items-center justify-between w-full h-full gap-4 lg:gap-8">
            ...
            <div className="flex flex-col justify-center text-left min-w-max">
               <h3 className="text-xl lg:text-2xl font-serif font-bold tracking-wide text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-500 leading-none">Anish Anto</h3>
               <p className="text-[9px] lg:text-[10px] font-mono text-green-400 tracking-[0.2em] uppercase mt-2 drop-shadow-[0_0_10px_rgba(74,222,128,0.3)]">Available Immediately</p>
            </div>
            <div className="w-px h-10 bg-white/20 shrink-0" />
            <div className="flex items-center gap-5 lg:gap-8 min-w-max">
               <div className="flex flex-col justify-center gap-2 text-[10px] lg:text-xs font-mono text-white/80">
                  <div className="flex items-center gap-2.5">
                    <MapPin className="w-3.5 h-3.5 opacity-70 text-orange-400" /> Ras Al Khaimah, UAE
                  </div>
                  <a href="tel:+971521379125" className="flex items-center gap-2.5 hover:text-orange-400 transition-colors">
                    <Phone className="w-3.5 h-3.5 opacity-70 text-orange-400" /> +971 521 379 125
                  </a>
               </div>
               <div className="flex items-center gap-3">
                  <a href="mailto:anishanto369@gmail.com" className="p-2.5 bg-white/5 border border-white/10 rounded-full hover:bg-orange-500/20 hover:border-orange-500/30 text-white/80 transition-all active:scale-90"><Mail className="w-4 h-4" /></a>
                  <a href="https://linkedin.com/in/anish-anto-ai" target="_blank" className="p-2.5 bg-white/5 border border-white/10 rounded-full hover:bg-orange-500/20 hover:border-orange-500/30 text-white/80 transition-all active:scale-90"><Linkedin className="w-4 h-4" /></a>
               </div>
            </div>
            <div className="flex items-center gap-3 lg:gap-4 shrink-0">
               <a href="/Anish_Anto_AI_PM.pdf" download className="h-11 lg:h-12 px-5 lg:px-6 bg-gradient-to-r from-red-500 to-orange-500 text-white text-[9px] lg:text-[10px] font-bold font-mono tracking-widest uppercase rounded-xl hover:scale-105 active:scale-95 transition-all shadow-lg flex items-center justify-center">
                  <Download className="w-3.5 h-3.5 mr-2" /> Resume
               </a>
               <a href="https://wa.me/971521379125" target="_blank" className="h-11 lg:h-12 px-7 lg:px-8 bg-white text-black text-[9px] lg:text-[10px] font-bold font-mono tracking-widest uppercase rounded-xl hover:bg-white/90 active:scale-95 transition-all shadow-lg flex items-center justify-center">
                  Hire Me
               </a>
            </div>
         </div>
      ...
      <div className="relative z-10 flex flex-col items-center w-full">
        ...
        <section className="flex h-screen w-full flex-col items-center justify-center px-4 text-center">
          ...
          <div className="absolute bottom-32 opacity-50 animate-bounce group cursor-pointer transition-opacity hover:opacity-100">
            <MoveDown className="h-8 w-8 text-white drop-shadow-lg" />
          </div>
        </section>
        ...
        <section className="flex min-h-screen w-full items-center justify-center md:justify-end px-6 md:px-32 py-24">
          <div className="max-w-4xl space-y-6 text-center md:text-right flex flex-col items-center md:items-end">
            <span className="text-[10px] font-bold bg-orange-500/20 text-orange-400 px-4 py-2 rounded-full uppercase tracking-widest font-mono border border-orange-500/30 shadow-xl">Sovereign Architecture</span>
            <h2 className="text-5xl md:text-9xl font-serif font-bold tracking-tighter text-transparent bg-clip-text bg-gradient-to-l from-red-500 to-orange-500 leading-none drop-shadow-[0_0_30px_rgba(0,0,0,0.8)]">Loomin-Docs</h2>
            <p className="text-xl md:text-4xl font-light text-white/95 max-w-2xl drop-shadow-xl">Air-Gapped Document Intelligence for Restricted RHEL 9 Environments.</p>
            <div className="w-full max-w-lg mt-8 bg-black/40 border border-white/10 rounded-2xl p-6 text-left font-mono text-[10px] md:text-xs text-green-400 shadow-2xl backdrop-blur-xl">
               <p className="text-green-500"># Initializing Sovereign Shield...</p>
            ...
            <div className="flex items-center justify-center md:justify-end gap-3 font-mono text-xs md:text-sm uppercase tracking-widest pt-6 font-bold text-white drop-shadow-lg">
        ...
        <section className="flex min-h-screen w-full items-center justify-center md:justify-start px-6 md:px-32 py-24">
          <div className="max-w-4xl space-y-6 flex flex-col items-center md:items-start text-left">
            ...
            <div className="w-full max-w-lg mt-8 bg-black/40 border border-white/10 rounded-2xl p-6 text-left font-mono text-[10px] md:text-xs text-red-400 shadow-2xl backdrop-blur-xl">
               ...
               <p className="text-green-500 font-bold">{`> Payload Cleaned. Routing... [SUCCESS]`}</p>
            </div>
            <div className="flex items-center gap-3 font-mono text-xs md:text-sm uppercase tracking-widest pt-6 font-bold text-white drop-shadow-lg">
        ...
        {/* --- 5. COMPLIANCE ORACLE (RIGHT) --- */}
        <section className="flex min-h-screen w-full items-center justify-center md:justify-end px-6 md:px-32 py-24">
          <div className="max-w-4xl space-y-6 text-center md:text-right flex flex-col items-center md:items-end">
            <span className="text-[10px] font-bold bg-amber-500/20 text-amber-300 px-4 py-2 rounded-full uppercase tracking-widest font-mono border border-amber-500/30 shadow-xl">Institutional GRC</span>
            <h2 className="text-5xl md:text-9xl font-serif font-bold tracking-tighter text-transparent bg-clip-text bg-gradient-to-l from-red-500 to-orange-500 leading-none drop-shadow-[0_0_30px_rgba(0,0,0,0.8)]">Compliance Oracle</h2>
            <p className="text-xl md:text-4xl font-light text-white/95 max-w-2xl drop-shadow-xl">Sovereign Multi-Agent GRC Engine for UAE 2026 Regulatory Landscapes.</p>
            <div className="w-full max-w-lg mt-8 bg-black/40 border border-white/10 rounded-2xl p-6 text-left font-mono text-[10px] md:text-xs text-amber-400 shadow-2xl backdrop-blur-xl">
               <p className="text-amber-500"># Cross-Referencing FTA / CBUAE Corpus...</p>
               <p className="text-white/40">{`> Analyzing Proliferation Financing Mandates... [SYNC]`}</p>
               <p className="text-white/40">{`> Redacting Financial Identifiers (Decree 45)... [ACTIVE]`}</p>
               <p className="text-green-500 font-bold">{`> Audit Report Verified & Digitally Signed.`}</p>
            </div>
            <div className="flex items-center justify-center md:justify-end gap-3 font-mono text-xs md:text-sm uppercase tracking-widest pt-6 font-bold text-white drop-shadow-lg">
               40-Hour Review automated to 60 Seconds <div className="w-2 h-2 bg-orange-500 rounded-full" />
            </div>
          </div>
        </section>

        {/* --- 6. DOCUMIND (LEFT) --- */}
        <section className="flex h-screen w-full items-center justify-center md:justify-start px-6 md:px-32 py-24">
        ...
        <motion.section 
          ...
          className="flex min-h-screen w-full items-center justify-center px-4 py-32 bg-black/40 backdrop-blur-sm"
        >
          <div className="w-full max-w-7xl space-y-20">
            <h2 className="text-4xl md:text-8xl font-serif font-bold text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-500 text-center drop-shadow-2xl">Expertise & Fluency</h2>
        ...
        <motion.section 
          initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp}
          className="flex min-h-screen w-full flex-col items-center justify-center py-32 bg-black/60 border-t border-white/10 backdrop-blur-xl"
        >
          <div className="w-full max-w-7xl px-4 space-y-24">
            <h2 className="text-4xl md:text-8xl font-serif font-bold text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-500 text-center drop-shadow-2xl">Foundation</h2>
            <div className="grid md:grid-cols-2 gap-24 text-center md:text-left">
               <div className="space-y-12">
                  ...
                  <div className="space-y-2 group">
                     <h4 className="text-xl font-bold text-white group-hover:text-orange-400 transition-colors">MBA (Finance)</h4>
                     <p className="text-sm font-mono text-white/60 uppercase">JAIN University | Aug 2026</p>
                  </div>
                  <div className="space-y-2 group">
                     <h4 className="text-xl font-bold text-white group-hover:text-orange-400 transition-colors">Bachelor of Commerce</h4>
               ...
               <div className="space-y-12">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 font-serif text-lg text-white/90">
                     <div className="hover:text-orange-400 transition-colors">Anthropic: Claude API</div>
                     <div className="hover:text-orange-400 transition-colors">Google: Generative AI</div>
                     <div className="hover:text-orange-400 transition-colors">Hugging Face: LLMs</div>
                     <div className="hover:text-orange-400 transition-colors">DeepLearning.AI: Prompt Eng</div>
                  </div>
               </div>
            </div>
          </div>
